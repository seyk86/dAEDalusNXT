...
void compute_influence_coefficients_vor3(double *grid,double *panels, double *colloc,double *te_idx,double *colloc_nvec,double *w,double *wind,mwSize n_colloc,double * Uinf)
{
    mwSize i,j,count=0;
        ...
        int nrhs, const mxArray *prhs[])
{
 ...
 /* ncols = mxGetN(prhs[0]);
  ...
  /*  set the output pointer to the output matrix */
    ...
    compute_influence_coefficients_vor3(grid,panels,colloc,te_idx,colloc_nvec,w,wind,n_colloc,Uinf);
