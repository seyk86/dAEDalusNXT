...
void compute_influence_vring(double *grid,double *panels, double *colloc,double *te_idx,double *colloc_nvec,double *w,mwSize n_colloc,double * Uinf,mwSize n_panels)
{
    mwSize i,j,count=0;
        ...
        int nrhs, const mxArray *prhs[])
{
 ...
 /* ncols = mxGetN(prhs[0]);
  ...
  /*  set the output pointer to the output matrix */
    ...
    compute_influence_vring(grid,panels,colloc,te_idx,colloc_nvec,w,n_colloc,Uinf,n_panels);
}
