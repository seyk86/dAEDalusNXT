...
%
function MeanAxisHybrid=simulate_free_flying_hybrid(aircraft,aircraft_structure,AeroelasticSSM,trimmed_state,ctrl_input,t_vec,dt,maneuver_name,movie_on)
