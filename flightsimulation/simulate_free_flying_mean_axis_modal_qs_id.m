...
%
function MeanAxisModal=simulate_free_flying_mean_axis_modal_qs_id(aircraft,aircraft_structure,n_modes,trimmed_state,ctrl_input,t_vec,dt,maneuver_name,movie_on)
...
MassInertiaIni=M_tot_mean(1:6,1:6);
for i=1:length(t_vec)
    ...
    [M_tot_mean,K_tot_mean,F_acc_mean]=compute_mean_axis_modal_matrices(A_Bar,I_Hat,b,b_Hat_Skew,omega_Hat_Skew,aircraft_structure.Mff,aircraft_structure.Kff,aircraft_structure.modeshapes,n_modes,xdot_now);
    M_tot_mean(1:6,1:6)=MassInertiaIni;
